...
dpa1 = np.loadtxt('Swelling_1dpa_10Cp.dat',skiprows=1)
dpa10 = np.loadtxt('Swelling_10dpa_10Cp.dat',skiprows=1)
dpa100 = np.loadtxt('Swelling_100dpa_10Cp.dat',skiprows=1)
...
plt.yscale('log')
plt.legend(loc='best')
plt.savefig('Swelling_T_10Cp.png')
plt.show()